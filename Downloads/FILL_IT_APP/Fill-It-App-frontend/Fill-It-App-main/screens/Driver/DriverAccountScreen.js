        ...
        <View style={styles.modalOverlay}>
          <View style={styles.personalInfoCard}>
            ...
            <View style={styles.modalRow}>
              <MaterialCommunityIcons name="car" size={24} color={COLORS.textSecondary} style={styles.modalRowIcon} />
              <Text style={styles.modalRowText}>{profileData.vehicleNumber}</Text>
            </View>
            ...
            <View style={styles.modalRow}>
              ...
              <TouchableOpacity onPress={() => setEditingPhoneNumber(!editingPhoneNumber)}>
                <Icon name={editingPhoneNumber ? 'check' : 'edit'} size={22} color={COLORS.textSecondary} />
              </TouchableOpacity>
            </View>
            {editingPhoneNumber && (
